...
<div class="text-center text-uppercase h1">Patients Information</div>
        ...
        <tbody class="success">
            ...
            <tr>
                ...
                <td>
                    ...
                    <a onclick="GetData('<?php echo $m->id ?>','<?php echo $m->name; ?>','<?php echo $m->age; ?>','<?php echo $m->gender; ?>','<?php echo $m->contact; ?>','<?php echo $m->address; ?>','<?php echo $m->occupation; ?>','<?php echo $m->date; ?>')" data-toggle="modal" data-target="#myModal">Edit</a>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h3 class="text-center">EDIT PATIENT DETAILS</h3>
            </div>
