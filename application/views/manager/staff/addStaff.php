...
<div class="container col-lg-6 modal fade" id="myModal" role="dialog">
    ...
    <form method="post" action="<?php echo base_url("/manager/addStaffInfo");?>" class="">
        <div class="col-lg-2">Name</div><div class="col-lg-10"><input class="form-control" type="text" name="name"></div><br><br>
        <div class="col-lg-2">NIC</div><div class="col-lg-10"><input class="form-control" type="number" name="age"></div><br><br>
        <div class="col-lg-2">DOB</div><div class="col-lg-10"><input class="" type="radio" name="gender" value="male">Male<br><input class="" type="radio" name="gender" value="female">Female</div><br><br>
        ...
        <div class="col-lg-2">Position</div><div class="col-lg-10"><input class="form-control" type="text" name="occupation"></div><br><br>
        <div class="col-lg-2">Salary</div><div class="col-lg-10"><input class="form-control" type="text" name="salary"></div><br><br>
